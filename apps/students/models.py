...
def student_photo_path(instance, filename):
    ...
    # admission_number is set by the DB sequence after first INSERT.
    # Photo uploads happen after the student record exists, so this is always populated.
    adm = instance.admission_number or "temp"
    return f'students/photos/{instance.school.id}/{instance.admission_year}/{adm}_{filename}'
...
class Student(SchoolScopedModel):
    ...
    # Auto-generated admission number — generated by the DB sequence via db_default.
    # Never set this in Python; the DB function generate_admission_number() is the sole authority.
