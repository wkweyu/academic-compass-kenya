...
class TeacherSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        """Create teacher with school_id from authenticated user"""
        # Get school from middleware context
        school = get_current_school()
        if not school:
            # Fallback: get from request user
        ...
        # Create teacher - full_name will be auto-generated by model's save method
