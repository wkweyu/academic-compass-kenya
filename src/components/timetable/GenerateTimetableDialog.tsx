...
import type { SchedulingConstraints, GenerationResult } from '@/types/timetable';
...
export const GenerateTimetableDialog = ({ classId, streamId, term, year, onResult, onClose }: Props) => {
